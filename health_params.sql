...
('URINE_OSMOLALITY', 50, 1200, 'mOsm/kg', 'Urine Osmolality', 'Concentration of solutes in urine', 'Renal'),
...
('BASOPHIL_ABS', 0.01, 0.1, 'x10^9/L', 'Absolute Basophil Count', 'Allergy/inflammation marker', 'Hematology'),
