...
Map<String, dynamic> _$HealthEntryToJson(HealthEntry instance) =>
    <String, dynamic>{
      ...
      'type': _$HealthEntryTypeEnumMap[instance.type]!,
...
const _$HealthEntryTypeEnumMap = {
...
Map<String, dynamic> _$VitalReadingToJson(VitalReading instance) =>
    <String, dynamic>{
      'vitalType': _$VitalTypeEnumMap[instance.vitalType]!,
...
MedicationCourse _$MedicationCourseFromJson(Map<String, dynamic> json) =>
    MedicationCourse(
...
Map<String, dynamic> _$MedicationCourseToJson(MedicationCourse instance) =>
    <String, dynamic>{
      'name': instance.name,
      'dose': instance.dose,
...
LabResultParameter _$LabResultParameterFromJson(Map<String, dynamic> json) =>
    LabResultParameter(
      name: json['name'] as String,
...
Map<String, dynamic> _$LabResultParameterToJson(LabResultParameter instance) =>
    <String, dynamic>{
      'name': instance.name,
      'value': instance.value,
      'unit': instance.unit,
